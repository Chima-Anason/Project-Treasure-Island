...
if choice1 == "left":
    ...
    if choice2 == "wait":
        ...
        if choice3 == "red":
            print("You are eaten by a giant bear.")
        elif choice3 == "yellow":
            print("You discover a secret passage to the woods.")
        elif choice3 == "blue":
            print("You find the treasure!")
        else:
            print("You are eaten by a shark and die.")
        
    elif choice2 == "swim":
        print("You get eaten by a shark and die.")
      
else:
    choice2 = input("You fell into a hole. Game over. \n").lower()
